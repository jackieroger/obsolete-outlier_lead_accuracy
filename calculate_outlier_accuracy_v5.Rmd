...
for (i in 1:length(outlier_leads)) {
  ...
  avgs <- lapply(measurement_stats_filtered, compute_avg)
  mins <- lapply(measurement_stats_filtered, compute_min)
  maxs <- lapply(measurement_stats_filtered, compute_max)
  ...
  write_tsv(summary, paste0('results/', outlier_leads[i], '-summary.tsv'))
